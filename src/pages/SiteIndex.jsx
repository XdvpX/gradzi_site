...
<div class="inner" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
<div style="flex: 1; min-width: 300px; padding-right: 20px;">
<p style="color: #fffacd; font-weight: 500;">
                    Your study abroad dreams deserve the best seat in the house — and we’re here to reserve it for you.
                    From <strong>world-class universities</strong> to <strong>life-changing academic
                    experiences</strong>,
                    Elements Overseas guides you every step of the way.
                </p>
<p style="color: #fffacd; font-weight: 500;">
                    With our global network, expert advice, and a knack for turning forms into fun (well, almost), we
                    make sure your journey from ambition to acceptance is smooth, exciting, and maybe even a little
                    adventurous.
                </p>
<ul class="actions">
<li><a class="button scrolly" href="#one">Explore Our Services</a></li>
</ul>
</div>
<div style="flex: 1; min-width: 300px; padding-right: 20px;">
<dotlottie-wc autoplay="" loop="" src="https://lottie.host/053c0d96-1460-430c-905b-0ca99b6d1928/GXcSKOT6qR.lottie" style="width: 110% ; background: transparent;"></dotlottie-wc>
</div>
</div>
</section>
<!-- One -->
...
<section>
<span class="icon solid major fa-passport"></span>
<h3>Visa Process</h3>
<p>Documentation, interview scheduling, mock sessions</p>
</section>
<section>
<span class="icon solid major fa-plane-departure"></span>
...
<h2>Get in touch</h2>
<p>
                Have questions? Drop us a message — we’ll get back to you faster than Netflix asks if you’re still
                watching.
            </p>
...
<span>Flat 501, MJ Metro View<br/>Nagole, Hyderabad<br/>500068</span>
</li>
<li>
...
<ul class="icons">
<li><a class="icon brands fa-instagram" href="https://www.instagram.com/gradzi.co/"><span class="label">Instagram</span></a></li>
<li><a class="icon brands fa-linkedin-in" href="#"><span class="label">LinkedIn</span></a></li>
</ul>
</li>
</ul>
<h3><i class="fas fa-map"></i> Reach Us</h3>
<div class="map-container" style="margin-top: 1em;">
<iframe allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3807.608271936734!2d78.55968957440386!3d17.38257270294526!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb98d4494089e5%3A0xf3cb900f6caee44f!2sM%20J%20METRO%20VIEW!5e0!3m2!1sen!2sin!4v1755537873906!5m2!1sen!2sin" style="width:100%; height:250px; border:0; border-radius: 8px;">
</iframe>
</div>
</section>
</div>
